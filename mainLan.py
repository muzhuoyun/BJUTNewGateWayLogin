...
parser.add_argument("-t", "--ipType", type=str, help="IP type. 'ipv6&ipv4', 'ipv4' or 'ipv6'.", default='ipv6&ipv4', choices=["ipv6&ipv4", "ipv6", "ipv4"], required=False)
